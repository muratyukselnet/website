...
function Header() {
    return <section className={style.headerSection} id="#top">
        <div className={style.headerWrapper}>
            <div className={style.imageHolder}>
                <img
                    src="/static/images/muratyuksel.png"
                    alt="Murat Yüksel"
                    width={500}
                    height={500}
                />
            ...
            <div
                ...
                <div className="flex content-center">
                    ...
                    <a href="https://twitter.com/muratyukselnet" target="_blank" className="ml-4 text-gray-500"
                       title="Twitter">
                        <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                             className="w-5 h-5" viewBox="0 0 24 24">
                            <path xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="https://www.instagram.com/fototropi/" target="_blank" className="ml-4 text-gray-500"
                       title="Instagram">
                    ...
                    <a href="https://www.linkedin.com/in/muratyukselnet" target="_blank" className="ml-4 text-gray-500"
                       title="Linkedin">
                        <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                             className="w-5 h-5" viewBox="0 0 24 24">
                            <path xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="https://t.me/muratyukselnet" target="_blank" className="ml-4 text-gray-500"
                       title="Telegram">
                        <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                             className="w-5 h-5" viewBox="0 0 24 24">
                            <path xmlns="http://www.w3.org/2000/svg"
